In order to compile the post-2-4 assignment module with conversion code, you will need to have at least r38224 version of the 2.4.x util module. 
...
indicated, all files referred to are in the root directory of the assignment
...
2) Edit the appropriate upgradeschema_*.config file for your database 
   (either upgradeschema_mysql.config or upgradeschema_oracle.config) and
