...
CoreEntityProvider, AutoRegisterEntityProvider, PropertyProvideable {
  ...
  public Map<String, String> getProperties(String reference) {
    ...
    try {
      ...
      props.put("url", "/portal/tool/" + placement + "?assignmentReference=" + assignment.getReference() + "&panel=Main&sakai_action=doView_submission");
